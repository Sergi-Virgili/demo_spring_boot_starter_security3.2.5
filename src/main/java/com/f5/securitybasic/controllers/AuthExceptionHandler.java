...
public class AuthExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> usernameExistingHandler(UsernameExistingException ex) {
        Map<String,String> body = new HashMap<>();
        body.put("message", ex.getMessage());
        body.put("satus", Integer.toString(HttpStatus.BAD_REQUEST.value()));
